            ...
            <div className="flex flex-col w-full h-1/2 justify-around items-center gap-4 ">
              <div className="flex flex-row items-start justify-between w-full ">
                <span className=" flextext-sm text-txt_secondary self-start  ">
                  Ja possui conta?
                  <a className="ml-1 text-secondary hover:underline cursor-pointer">Entrar</a>
                </span>

              </div>
              <div className="flex flex-col w-full justify-end items-center gap-4">
                <button hidden  id="register" className="w-full h-12 rounded-lg shadow-sm focus:outline-none pointer-events-auto hover:bg-orange-300 hover:text-orange-500 focus:border-secondary px-4 bg-secondary text-white font-bold">
                  Enviar
                </button>
              </div>
            </div>
